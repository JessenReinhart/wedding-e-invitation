...
const MusicPlayer: React.FC<{ className?: string }> = ({ className }) => {
  ...
  return (
    <div className={className}>
      <button onClick={togglePlay} className={`${isPlaying ? 'playing' : ''} flex flex-col md:bg-rose-gold shadow-none md:p-4 md:rounded-lg md:shadow-lg hover:shadow-xl transition-shadow duration-300`}>
